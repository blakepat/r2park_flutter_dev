...
class UserManager {
  ...
  Future<List<User>> getUsers2() async {
    ...
    // var url = Uri.http('localhost', 'get_users.php');
    ...
    // debugPrint(databaseUsersList[198].toString());
    print(databaseUsersList.length);

    // final user = User.convertFromJson(users[198]);

    // List<User> convertedUsersArray = [];

    // for (var user in databaseUsersList) {
    //   convertedUsersArray.add(User.fromJson(user));
    // }

    // print(convertedUsersArray[198].firstName);
