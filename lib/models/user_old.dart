...
//     data['created'] = this.created.toString().split(".")[0];
...
//     data['joining_date'] = this.joiningDate.toString().split(".")[0];
//     data['date_of_birth'] = this.dateOfBirth.toString().split(".")[0];
...
//     data['member_since'] = this.memberSince.toString().split(".")[0];
...
//         'auth_level': this.authorityLevel.toString(),
//         'password': this.password,
//         'user_image': this.userImage,
//         'role': this.role,
//         'otp': this.otp.toString(),
//         'status': this.status.toString(),
//         'enrollServices': this.enrollServices.toString(),
...
//         'state': this.state,
//         'created': this.created.toString().split(".")[0],
...
//         'enforceId': this.enforceID.toString(),
//         'work_location': this.workLocation,
//         'gender': this.gender,
//         'joining_date': this.joiningDate.toString().split(".")[0],
//         'date_of_birth': this.dateOfBirth.toString().split(".")[0],
...
//         'access_properties': this.accessProperties,
//         'accessed_by_client': this.accessedByClient.toString(),
//         'is_contact': this.isContact.toString(),
//         'accessed_by_property': this.accessedByProperty.toString(),
//         'allow_dashboard': this.allowDashboard.toString(),
//         'title': this.title,
//         'position': this.position,
//         'visible_access': this.visibleAccess.toString(),
//         'area': this.area,
//         'country': this.country,
//         'zone': this.zone,
//         'userId': this.userId,
//         'property_types': this.propertyTypes,
//         'condo_number': this.condoNumber,
//         'condo_name': this.condoName,
//         'condo_addr': this.condoAddress,
//         'login_id': this.loginId,
//         'member_since': this.memberSince.toString().split(".")[0],
//         'home_phone': this.homePhone,
//         'business_phone': this.businessPhone,
//         'email2': this.email2,
//         'mailing_address': this.mailingAddress,
//         'signature': this.signature,
//         'employee_role': this.employeeRole.toString(),
//         'mleo_id': this.mleoId,
//         'default_show': this.defaultShow.toString(),
//         'signvendorId': this.signVendorId.toString(),
//         'multi_zone': this.multiZone,
//         'latitude': this.latitude,
//         'longitude': this.longitude,
//         'holiday_rate': this.holidayRate,
//       };
// }
